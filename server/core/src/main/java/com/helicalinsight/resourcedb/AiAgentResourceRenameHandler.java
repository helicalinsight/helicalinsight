...
@Component("agentRenameHandler")
@Scope("prototype")
public class AiAgentResourceRenameHandler extends AbstractResourceRenameAction {
    ...
    public Boolean performAction() {
        ...
        if (null != hiResource) {
            HIResourceAIAgent hiAiAgent = hiResource.getAiAgent();
            if (null != hiAiAgent) {
                hiResource.setTitle(updatedName);
                Date lastUpdatedTime = new Date();
                hiResource.setLastUpdatedTime(lastUpdatedTime);
                hiAiAgent.setLastUpdatedTime(lastUpdatedTime);
                hiAiAgent.setAgentName(updatedName);
