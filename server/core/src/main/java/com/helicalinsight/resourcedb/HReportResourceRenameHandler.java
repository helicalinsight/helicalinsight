...
@Component("hrRenameHandler")
@Scope("prototype")
public class HReportResourceRenameHandler extends AbstractResourceRenameAction {
    ...
    public Boolean performAction() {
        ...
        if (null != hiResource) {
            ...
            try {
                ...
                //hiResourceServiceDB.editHIReport(hiResourceHReport);
