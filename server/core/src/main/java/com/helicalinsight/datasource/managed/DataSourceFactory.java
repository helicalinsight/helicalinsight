...
class DataSourceFactory implements IDataSourceFactory {
    ...
    @Nullable
    public javax.sql.DataSource sqlDataSource(@NotNull String json) {
    ...
    @Nullable
    private javax.sql.DataSource getDataSource(@NotNull HashMapKey hashMapKey, String json, Map<HashMapKey,
