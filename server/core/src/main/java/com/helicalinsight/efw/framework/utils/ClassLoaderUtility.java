...
public class ClassLoaderUtility {
    ...
    private static boolean check(String clazz, @NotNull Method findLoadedClassMethod,
    ...
    private static boolean find(String clazz, @NotNull Method findLoadedClassMethod, ClassLoader classLoader) {
        try {
    ...
    private static void log(String clazz, @NotNull ClassLoader classLoader) {
        if (logger.isDebugEnabled()) {
