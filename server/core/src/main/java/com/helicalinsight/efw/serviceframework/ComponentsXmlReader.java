...
public class ComponentsXmlReader {
    ...
    @Nullable
    private String getComponentNodeJson(@NotNull JSONObject componentsXmlJson, String type, String serviceType,
    ...
    @Nullable
    private String getRequiredJson(@NotNull JSONObject componentsXmlJson, String type, String serviceType,
                                   String service, @Nullable String classifier, String processingMode) {
        ...
        try {
            ...
            for (Object aComponent : componentsArray) {
                ...
                String componentsClassifier = component.getString("@classifier");

                if (Arrays.asList(componentsClassifier.replaceAll("\\s*", "").split(",")).contains(classifier)) {
    ...
    @Nullable
    private String getJsonFromImports(@NotNull JSONObject componentsXmlJson, String type, String serviceType,
                                      String service, String classifier, String processingMode) {
