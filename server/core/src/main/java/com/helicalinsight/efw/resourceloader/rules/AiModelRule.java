...
public final class AiModelRule extends AbstractResourceRule implements IResourceRule {
    ...
    public static IResourceRule getInstance() {
        return AiModelRuleHanlder.INSTANCE;
    }
     ...
     * call to getInstance.
     */
    private static class AiModelRuleHanlder {
        public static final IResourceRule INSTANCE = new AiModelRule();
    }
}