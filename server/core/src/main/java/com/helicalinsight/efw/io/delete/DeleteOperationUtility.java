...
public class DeleteOperationUtility {
    ...
    private boolean trySatisfyingRules(File directory) throws UnSupportedRuleImplementationException {
        ...
        /*if (!isIndexFilePresent(directory) || !isAuthorized(directory)) {
            logger.info("Can't delete " + directory + ". Aborting the operation due to " +
                    "insufficient privileges.");
            throw new OperationFailedException("You may not have " + "sufficient privileges. " +
                    "Operation aborted. ");
            //return false;
        }*/
