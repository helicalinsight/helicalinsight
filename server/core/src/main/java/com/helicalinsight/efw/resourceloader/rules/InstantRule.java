...
public final class InstantRule extends AbstractResourceRule implements IResourceRule {
    ...
    public static IResourceRule getInstance() {
        return InstantReportRuleHanlder.INSTANCE;
    }
     ...
     * call to getInstance.
     */
    private static class InstantReportRuleHanlder {
        public static final IResourceRule INSTANCE = new InstantRule();
    }
}