...
public class ServerSideExportComponent {
    ...
    public void copyReportFromTemp() {
        ...
        String destinationFile = properties.getSolutionDirectory() + File.separator +
                resultDirectory +
                File.separator + principal.getUsername() + "_" + principal.getOrg_name() + "_" +
    ...
    public String saveEfwResultFile() {
        ...
        String orgName = principal.getOrg_name();
        String outputFleName = resultDirectoryLocation + File.separator + username +
                "_" + orgName + "_" + fileToBeSaved.getName();
        String resultFile = username + "_" + orgName + "_" + fileToBeSaved.getName();
