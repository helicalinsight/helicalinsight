 ...
 */
@Component
public class ResourceAuthenticator implements IResourceAuthenticator, CheckConstant {
    ...
    public boolean authenticate(@NotNull HttpServletRequest request, @Nullable Context urlContext) {
        ...
        if (urlContext.getLookupParameters() == null && minimumPermissionRequired == null) {
            ...
            if (minimumPermissionRequired != null) {//Default lookup
                ...
                boolean isDataSourceLookup = isDataSourceLookup(lookupParameters);
    ...
    protected boolean processRequest(@Nullable Integer minimumPermissionRequired, String resource) {
    ...
    private int permission(String resource) {
        ...
        fileAsJson.addProperty("absolutePath", resource);
    ...
    private String isScripted(JsonObject formData, DecisionState decisionState) {
        ...
        String resource = result.get("resource").getAsString();
        return processRequest(permission, resource) + "";
    }
