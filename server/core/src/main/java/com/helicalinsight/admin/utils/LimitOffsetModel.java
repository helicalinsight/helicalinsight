...
public class LimitOffsetModel {
    ...
    private boolean onlySuperOrganization;

    private boolean requestedWithSpecificOrganization;
    ...
    public boolean isOnlySuperOrganization() {
        return onlySuperOrganization;
    }

    public void setOnlySuperOrganization(boolean onlySuperOrganization) {
        this.onlySuperOrganization = onlySuperOrganization;
    }

    public boolean isRequestedWithSpecificOrganization() {
        return requestedWithSpecificOrganization;
    }

    public void setRequestedWithSpecificOrganization(boolean requestedWithSpecificOrganization) {
        this.requestedWithSpecificOrganization = requestedWithSpecificOrganization;
    }
