...
import com.helicalinsight.instant.ai.service.IAiUtilityConfigService;
 ...
 * </ol>
 */
public class AiUtilityConfigServiceImpl implements IAiUtilityConfigService {
    ...
    @Override
    public void execute(String utilityPath, HttpServletRequest request, HttpServletResponse response)
            throws IOException {
        ...
        try {
            ...
            InstantBIUtils.addSessionContext(request, payload);

            logger.info("Proxying InstantBI utility path={} keys={}", utilityPath, payload.keySet());
            String botResponse = InstantBIServiceFactory.getHttpService().callHttp(utilityPath, payload);
