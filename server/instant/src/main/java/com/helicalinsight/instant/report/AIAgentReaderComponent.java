...
public class AIAgentReaderComponent implements IComponent {
	/**
    ...
    public String executeComponent(String jsonFormData) {
        ...
        final AdhocReport adhocReport = (AdhocReport) ReportOpenHelper.getAgentStateDb(directory, fileName);
        if (adhocReport == null) {
            throw new IllegalArgumentException("The file " + fileName + " doesn't exists. " +
                    "Aborting operation.");
        }

        return ReportOpenHelper.getAgentContentAsJson(adhocReport).toString();
    }
