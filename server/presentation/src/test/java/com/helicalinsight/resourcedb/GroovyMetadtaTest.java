...
public class GroovyMetadtaTest {
	...
	public void md_a1_create_a_folder_to_save_metadata() throws Exception {
		...
		map.put("folderName", "MetadataWithGroovy");
	...
	@Test
	public void md_a2_test_plain_groovy_DataSourceConnection() throws Exception {
	...
	@Test
	public void md_a3_create_plain_groovy_Datasource() throws Exception {
		MockHttpServletRequestBuilder mockHttpServletRequestBuilder = MockMvcRequestBuilders.post("/services");
		Map<String, String> map = new HashMap<>();
		map.put("type", "core");
		map.put("serviceType", "dataSource");
	...
	public void md_a4_expand_catalog_schema() throws Exception {
		...
		map.put("formData", "{\"id\":\"" + firstJdbcId
				+ "\",\"type\":\"sql.jdbc.groovy\",\"dir\":\"MetadataWithGroovy\",\"parameters\":{\"fetchCatalogs\":true,\"fetchSchemas\":true,\"view\":\"tree\",\"skipped\":true}}");
		RequestBuilder builder = TestUtility.getMockHttpServletRequestBuilder(mockHttpServletRequestBuilder, map);
		this.efwMock.perform(builder).andExpect(MockMvcResultMatchers.status().isOk())
				.andExpect(MockMvcResultMatchers.jsonPath("$.status").value(1));
	}
	...
	public void md_a5_expand_table() throws Exception {
		...
		map.put("service", "metadataWorkflow");
		map.put("formData", "{\"id\":\"" + firstJdbcId
				+ "\",\"type\":\"sql.jdbc.groovy\",\"dir\":\"MetadataWithGroovy\",\"parameters\":{\"fetchTables\":true,\"fetchData\":[{\"schemas\":[{\"name\":\"HIUSER\"}]}]}}");
		RequestBuilder builder = TestUtility.getMockHttpServletRequestBuilder(mockHttpServletRequestBuilder, map);
		this.efwMock.perform(builder).andExpect(MockMvcResultMatchers.status().isOk())
				.andExpect(MockMvcResultMatchers.jsonPath("$.status").value(1));
	}
	...
	public void md_a6_createMetadata() throws Exception {
		...
		String formData = "{\"database\":\"HIUSER\",\"classifier\":\"db.workflow\",\"duplicate\":{\"table\":[],\"column\":[]},\"joins\":[],\"access\":{\"expression\":[]},\"dataSource\":{\"id\":\""+firstJdbcId+"\",\"type\":\"sql.jdbc.groovy\",\"baseType\":\"sql.jdbc.groovy\",\"catSchemaPredicted\":false,\"sync\":false,\"catalog\":\"\",\"schema\":\"HIUSER\",\"dir\":\"MetadataWithGroovy\",\"connId\":\"yfj7o\",\"classifier\":\"db.workflow\",\"database\":\"HIUSER\"},\"removeItem\":{\"tables\":[],\"columns\":[],\"views\":[]},\"addItem\":{\"tables\":[\"4ac5d9f68b58bd7c0d179146e46795be\",\"4e1fd245f4d13b77be423a43f01d80b2\",\"be534112989b616b194bc59c2fb25a42\",\"9645c648a1c0dbeec1287aaf1e996db3\",\"8a28627d07d04ef096d9935f12e0c7e9\"],\"columns\":[],\"views\":[]},\"changeItem\":{\"tables\":[],\"columns\":[]},\"fileName\":\"SaveSelectAll\",\"location\":\"MetadataWithGroovy\",\"metadataReload\":true}";
		map.put("formData",formData);
		RequestBuilder builder = TestUtility.getMockHttpServletRequestBuilder(mockHttpServletRequestBuilder, map);
	...
	public void md_a7_share_Metadata() throws Exception {
		...
		map.put("service", "update");
		String formData = "{\"share\":{\"user\":[{\"id\":2,\"permission\":2}]},\"type\":\"file\",\"dir\":\"MetadataWithGroovy\",\"file\":\"SaveSelectAll.metadata\"}";
		map.put("formData", formData);
		RequestBuilder builder = TestUtility.getMockHttpServletRequestBuilder(mockHttpServletRequestBuilder, map);
	...
	@Test
	public void md_a9_groovy_jdbc_cascade_delete() throws Exception {
		MockHttpServletRequestBuilder mockHttpServletRequestBuilder = MockMvcRequestBuilders.post("/services");
		Map<String, String> map = new HashMap<>();
		map.put("type", "core");
		map.put("serviceType", "dataSource");
		map.put("service", "delete");
		String formData = "{\"classifier\":\"efwd\",\"id\":\""+firstJdbcId+"\",\"type\":\"cascade\",\"directory\":\"MetadataWithGroovy\"}";
		map.put("formData", formData);
		RequestBuilder builder = TestUtility.getMockHttpServletRequestBuilder(mockHttpServletRequestBuilder, map);
		this.efwMock.perform(builder).andExpect(MockMvcResultMatchers.status().isOk())
				.andExpect(MockMvcResultMatchers.jsonPath("$.status").value(1))
	...
	@Test
    public void md_b1_verifyDelete() throws Exception {
       HIResource resource =  serviceDb.getResourceByUrl("MetadataWithGroovy/SaveSelectAll.metadata");
       assertNull(resource);
    }
	
  
	@Test
    public void md_b2_deleteFolder() throws Exception {
        MockHttpServletRequestBuilder mockHttpServletRequestBuilder = MockMvcRequestBuilders
                .post("/fileSystemOperations");
        String input = "[\"MetadataWithGroovy\"]";
        Map<String, String> map = new HashMap<>();
