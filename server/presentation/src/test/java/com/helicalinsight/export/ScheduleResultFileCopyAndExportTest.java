...
public class ScheduleResultFileCopyAndExportTest {
	...
	public void sch_a1_init() throws Exception {
		...
		testUtility.createFolder("ScheduleResultFileCopyAndExportTest");
	...
	public void sch_a4_schedule_for_report() throws Exception{
		...
		map.put("command", "add");
		map.put("reportDirectory", "ScheduleResultFileCopyAndExportTest");
		map.put("reportFile", "report1.hr");
		map.put("location", "ScheduleResultFileCopyAndExportTest");
		...
		JSONObject data = (JSONObject) JSONObject.fromObject(result.getResponse().getContentAsString()).getJSONObject("response").getJSONArray("data").get(0);
		path = data.getString("path");
	}
	
	@Test
	public void sch_a5_1_copy_schedule_result_file() throws Exception {
		testUtility.createFolder("AnotherFolderToStoreScheduleResultFile");
        ...
        String formData = "{\"sourceUrl\":\""+path+"\",\"destinationUrl\":\"AnotherFolderToStoreScheduleResultFile\",\"sourcePermission\":\"5\",\"destPermission\":\"5\",\"isConflictSkip\":true}";
        map.put("action", "copy");
	...
	@Test
	public void sch_a5_export() throws Exception {
		String request = "{\"dir\": \"ScheduleResultFileCopyAndExportTest\",\"file\" : \"\",\"options\": {\"share\": true,\"dataSource\": true,\"schedules\": true}}";
		fileName = testUtility.exportResource(request, TESTURL);
	}
	
	@Test
	public void sch_a6_delete() throws Exception {
		testUtility.deleteResource("ScheduleResultFileCopyAndExportTest");
		testUtility.deleteResource("AnotherFolderToStoreScheduleResultFile");
		testUtility.clearRecycleBin();
		Assert.assertNull(serviceDb.getResourceByUrl("ScheduleResultFileCopyAndExportTest"));
		Assert.assertNull(serviceDb.getResourceByUrl("AnotherFolderToStoreScheduleResultFile"));
	}
	
	@Test
	public void sch_a7_import() throws Exception {
		...
		Assert.assertNotNull(serviceDb.getResourceByUrl(path));
		Assert.assertNotNull(serviceDb.getResourceByUrl("AnotherFolderToStoreScheduleResultFile/"+fileName));
	}
