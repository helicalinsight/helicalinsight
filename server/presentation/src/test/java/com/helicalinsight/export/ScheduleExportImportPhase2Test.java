...
public class ScheduleExportImportPhase2Test {
	MockMvc efwMock;
	MockMvc mockMvc;
	@Autowired
	...
	public void exp_a1_init() throws Exception {
		...
		testUtility.createFolder("EFWSRShareExportImportTest");
	...
	public void exp_a4_schedule_for_report() throws Exception{
		...
		map.put("command", "add");
		map.put("reportDirectory", "EFWSRShareExportImportTest");
		map.put("reportFile", "report1.hr");
		map.put("location", "EFWSRShareExportImportTest");
		...
		String[] dirAndFile = url.split("/");
		String formData = "{\"share\":{\"user\":[{\"id\":\"2\",\"permission\":\"5\"}]},\"type\":\"file\",\"dir\":\""+dirAndFile[0]+"\",\"file\": \""+dirAndFile[1]+"\"}";
	...
	@Test
	public void exp_a5_export_a_scheduled_report() throws Exception {
		String request = "{\"dir\": \"EFWSRShareExportImportTest\",\"file\" : \"report1.hr\",\"options\": {\"share\": true,\"dataSource\": true,\"schedules\": true}}";
		fileName = testUtility.exportResource(request, TESTURL);
	}
	
	@Test
	public void exp_a6_delete() throws Exception {
		testUtility.deleteResource("EFWSRShareExportImportTest");
		testUtility.clearRecycleBin();
	}
	
	@Test
	public void exp_a7_import_scheduled_report() throws Exception {
		...
		HIResource report1 =  serviceDb.getResourceByUrl("EFWSRShareExportImportTest/report1.hr");
	...
	@Test
	public void exp_a8_import_scheduled_report_again() throws Exception {
		String request = "{\"onConflict\" : \"skip\",\"upload\":true,\"options\" :{\"share\" : true,\"dataSource\": true,\"schedules\" : true}}";
		testUtility.importResource(request, TESTURL, fileName);
