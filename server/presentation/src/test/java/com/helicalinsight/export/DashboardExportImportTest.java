...
public class DashboardExportImportTest {
	...
	public void exp_a1_init() throws Exception {
		testUtility.createFolder("DashboardTest");
	...
	public void exp_a4_share_report1_with_user() throws Exception {
		...
		map.put("type", "core");
		map.put("formData",
				"{\"share\":{\"user\":[{\"id\":\"2\",\"permission\":\"2\"}]},\"type\":\"file\",\"dir\":\"DashboardTest\",\"file\":\"report1.hr\"}");
	...
	public void exp_a6_share_report2_with_user() throws Exception {
		...
		map.put("type", "core");
		map.put("formData",
				"{\"share\":{\"user\":[{\"id\":\"2\",\"permission\":\"2\"}]},\"type\":\"file\",\"dir\":\"DashboardTest\",\"file\":\"report2.hr\"}");
		RequestBuilder builder = TestUtility.getMockHttpServletRequestBuilder(mockHttpServletRequestBuilder, map);
		this.efwMock.perform(builder).andExpect(MockMvcResultMatchers.status().isOk())
				.andExpect(MockMvcResultMatchers.jsonPath("$.status").value(1))
				.andExpect(MockMvcResultMatchers.jsonPath("$.response.message")
	...
	public void exp_a8_share_design_with_user() throws Exception {
		...
		map.put("type", "core");
		map.put("formData",
				"{\"share\":{\"user\":[{\"id\":\"2\",\"permission\":\"2\"}]},\"type\":\"file\",\"dir\":\"DashboardTest\",\"file\":\"dashboard.efwdd\"}");
		RequestBuilder builder = TestUtility.getMockHttpServletRequestBuilder(mockHttpServletRequestBuilder, map);
		this.efwMock.perform(builder).andExpect(MockMvcResultMatchers.status().isOk())
				.andExpect(MockMvcResultMatchers.jsonPath("$.status").value(1))
				.andExpect(MockMvcResultMatchers.jsonPath("$.response.message")
	...
	@Test
	public void exp_a9_schedule_for_design() throws Exception{
		MockHttpServletRequestBuilder mockHttpServletRequestBuilder = MockMvcRequestBuilders.post("/saveReport");
		Map<String, String> map = new HashMap<>();
		map.put("command", "add");
		map.put("reportDirectory", "DashboardTest");
		map.put("reportFile", "dashboard.efwdd");
		map.put("location", "DashboardTest");
	...
	public void exp_b1_exportAFolder() throws Exception {
		String request = "{\"dir\": \"DashboardTest\",\"file\" : \"\",\"options\": {\"share\": true,\"dataSource\": true,\"schedules\": true}}";
		fileName = testUtility.exportResource(request, TESTURL);
	}
	
//	@Test
//	public void exp_b2_importAFolderSharedWithUserHavingMetadata_onConflict_update() throws Exception {
//		exp_cleanup();
...
//		HIResource resource = serviceDb.getResourceByUrl("DashboardTest/dashboard.efw");
//		Assert.assertNotNull(resource);
//		HIResourceEFW efw = resource.getHiResourceEFW();
//		Assert.assertNotNull(efw);
//		Integer contentId = efw.getEfwContentId();
...
//	@Test
//	public void exp_b3_exportAFolder() throws Exception {
//		String request = "{\"dir\": \"DashboardTest\",\"file\" : \"\",\"options\": {\"share\": true,\"dataSource\": true,\"schedules\": true}}";
//		fileName = testUtility.exportResource(request, TESTURL);
//		// importing the exported folder again :: BUG  6658 :: 
//		exp_b2_importAFolderSharedWithUserHavingMetadata_onConflict_update();
//		
//	}
