...
public class ScheduleResultFileDeleteTest {
	...
	public void sch_a1_init() throws Exception {
		...
		testUtility.createFolder("ScheduleResultFileDeleteTest");
	...
	public void sch_a4_schedule_for_report() throws Exception{
		...
		map.put("command", "add");
		map.put("reportDirectory", "ScheduleResultFileDeleteTest");
		map.put("reportFile", "report1.hr");
		map.put("location", "ScheduleResultFileDeleteTest");
		...
		testUtility.deleteResource(path);
	}
	
	@Test
	public void sch_a5_export() throws Exception {
		String request = "{\"dir\": \"ScheduleResultFileDeleteTest\",\"file\" : \"\",\"options\": {\"share\": true,\"dataSource\": true,\"schedules\": true}}";
		fileName = testUtility.exportResource(request, TESTURL);
	}
	
	@Test
	public void sch_a6_delete() throws Exception {
		testUtility.deleteResource("ScheduleResultFileDeleteTest");
		testUtility.clearRecycleBin();
		Assert.assertNull(serviceDb.getResourceByUrl("ScheduleResultFileDeleteTest"));
	}
	...
	public void sch_a7_import() throws Exception {
		...
		Assert.assertNotNull(serviceDb.getResourceByUrl("ScheduleResultFileDeleteTest"));
