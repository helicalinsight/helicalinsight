...
public class HIRecycleBinDaoImplTest {
	...
	public void deleteRecycleBinsByResourceIdsSkipsWhenNullOrEmpty() {
		assertTrue(dao.deleteRecycleBinsByResourceIds(null).isEmpty());
		assertTrue(dao.deleteRecycleBinsByResourceIds(Collections.emptyList()).isEmpty());
	...
	public void deleteRecycleBinsByResourceIdsSkipsMutationsWhenNoBinsFound() {
		...
		assertTrue(dao.deleteRecycleBinsByResourceIds(List.of(10, 11)).isEmpty());
	...
	public void deleteRecycleBinsByResourceIdsDeletesLinksThenHeaders() {
		...
		assertEquals(List.of(70L, 71L), dao.deleteRecycleBinsByResourceIds(List.of(10, 11)));
