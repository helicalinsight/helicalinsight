...
public class EFWDDLinkedDataDeleteTest {
	...
	@Test
	public void efwdd_a1_init() throws Exception {
	...
	@Test
	public void efwdd_a2_createMetadata() throws Exception {
	...
	@Test
	public void efwdd_a3_create_Report() throws Exception {
	...
	@Test
	public void efwdd_a4_create_designer_report() throws Exception {
	...
	@Test
	public void efwdd_a5_delete_root_folder() throws Exception {
		testUtility.deleteResource("DashboardTest");
	}
	
	@Test
	public void efwdd_a6_delete_root_from_rb() throws Exception {
		String binId = testUtility.getRecycleBinIdByResourcePath("DashboardTest");
		String formData="{\"action\":\"fetchDetails\",\"recycleBinIds\":["+binId+"]}";
		String resp=testUtility.recycleBinAction(formData);
		JSONObject jsonObject = JSONObject.fromObject(resp);
		JSONObject responseObject = jsonObject.getJSONObject("response").getJSONObject(binId).getJSONObject("data");
		JSONArray array = responseObject.getJSONArray("resources");
		JSONObject efwdd=(JSONObject)array.get(2);
		HIResource efwddResource=serviceDb.getDeletedResourceById(efwdd.getInt("resourceId"));
		efwddParentId=efwddResource.getParentId();
		String formData2="{\"action\":\"delete\",\"recycleBinIds\":["+binId+"],\"force\":true}";
		testUtility.recycleBinAction(formData2);
	}
	
	@Test
	public void efwdd_a7_verify_delete() throws Exception {
		Assert.assertNull(serviceDb.getHIResourceEFWContents(efwddParentId));
	}
	
	@Test
	public void efwdd_a8_repeat() throws Exception {
		efwdd_a1_init();
		efwdd_a2_createMetadata();
		efwdd_a3_create_Report();
		efwdd_a4_create_designer_report();
		//testUtility.deleteResource("DashboardTest/dashboard.efwdd");
		testUtility.deleteResource("DashboardTest");
	}
	
	private JSONArray listFileBrowserData() throws Exception {
	...
	@Test
	public void efwdd_b1_verify_delete() throws Exception {
		Assert.assertNull(serviceDb.getHIResourceEFWContents(efwddParentId));
	}
