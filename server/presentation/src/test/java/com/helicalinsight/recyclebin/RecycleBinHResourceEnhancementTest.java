...
public class RecycleBinHResourceEnhancementTest {
	 ...
	 * 3. Create Metadata In Parent
	 * 4. Create HReport In Nested Folder
	 * 5. Delete Main Folder
	 * 6. Verify Recyclebin
	 * 7. Restore Main Folder
	 * 8. Verify RecycleBin
	 * 9. Permanently delete Folder
	 * 10. Verify RecycleBin
	 * 11. Verify Database.
	 * 12. Clean
	 */
	...
	public void rec_a1_create_a_folder() throws Exception {
		...
		testUtility.createFolder("RecycleBinHResourceEnhancementTest");
	}

	@Test
	public void rec_a2_createNestedFolder() throws Exception {
		testUtility.createFolder("NestedFolder",List.of("RecycleBinHResourceEnhancementTest"));
	}
	...
	public void rec_a7_restoreRecursively() throws Exception {
		...
		Assert.assertEquals(4,responseObj.getJSONObject("response").getJSONObject("recycleBin").getJSONArray("completed").size() );
	}
	
	@Test
	public void rec_a8_verifyRecycleBin_recursiveRestore() throws Exception {
		JsonArray binArr =  testUtility.listRecycleBin();
		Assert.assertEquals(0, binArr.size());
	}
	
	@Test
	public void rec_a9_permanentlyDeleteMainFolder() throws Exception {
		testUtility.deleteResource("RecycleBinHResourceEnhancementTest");
		mainFolderBinId = testUtility.getRecycleBinIdByResourceName("RecycleBinHResourceEnhancementTest");
		String formData = "{\"action\":\"delete\",\"recycleBinIds\":["+mainFolderBinId+"]}";
		testUtility.recycleBinAction(formData);
	}
	
	@Test
	public void rec_b1_verifyRecycleBin() throws Exception {
		JsonArray recycleBinList =  testUtility.listRecycleBin();
		Assert.assertEquals(0, recycleBinList.size());
	}
	
	@Test
	public void rec_b2_verifyDatabase() throws Exception {
		HIResourceServiceDB serviceDb = ApplicationContextAccessor.getBean(HIResourceServiceDB.class);
		Assert.assertNull(serviceDb.getResourceByUrl("RecycleBinHResourceEnhancementTest"));
		Assert.assertNull(serviceDb.getResourceByUrl("RecycleBinHResourceEnhancementTest/NestedFolder"));
		Assert.assertNull(serviceDb.getResourceByUrl("RecycleBinHResourceEnhancementTest/Metadata_1.metadata"));
		Assert.assertNull(serviceDb.getResourceByUrl("RecycleBinHResourceEnhancementTest/NestedFolder/report1.hr"));
	}
