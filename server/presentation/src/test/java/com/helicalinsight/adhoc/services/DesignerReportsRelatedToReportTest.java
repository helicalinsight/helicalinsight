...
public class DesignerReportsRelatedToReportTest {

	@Test
	public void ut_a1_test_executeComponent() throws JAXBException {
		DesignerReportsRelatedToReport report = new DesignerReportsRelatedToReport();
		...
		EfwDashboardDesigner efwsrFileObj = mock(EfwDashboardDesigner.class);
		...
		when(efwsrFileObj.getState()).thenReturn(stateJSON.toString());
		...
		when(jaxbContexts.getContextForClass(EfwDashboardDesigner.class)).thenReturn(jaxbContext);
