            ...
            <ul class="nav nav-sidebar discover-block">
                ...
                <li>
                    ...
                    <ul class="collapse" id="getting-started">
                        <li><a href="http://www.helicalinsight.com/getting-started/getting-started-hi/" target="_blank">
                            Helical insight</a></li>
                        <li><a href="http://www.helicalinsight.com/getting-started/user-role-management/" target="_blank">
                            User & role management</a></li>

                        <li><a href="http://www.helicalinsight.com/file-repository/repository-ui-introduction/"
                               target="_blank">
                ...
                <li>
                    ...
                    <ul class="collapse" id="connecting-data">
                        <li><a href="http://www.helicalinsight.com/adhoc-basic-customization/adhoc-datasource/"
                               target="_blank">
                            Connecting to a data source </a></li>
                        <li><a href="http://www.helicalinsight.com/adhoc-module/view-and-edit-in-datasource/"
                               target="_blank">
                ...
                <li>
                    <a target="_blank" href="http://www.helicalinsight.com/technical-guide/efw-for-report-creation/">
                        <i class="flaticon-play-button-1"></i> Creating Reports</a>
                </li>
                <li>
                    <a target="_blank" href="http://www.helicalinsight.com/learn/"> <i class="flaticon-play-button-1"></i>
                        Learn More</a>
                </li>
            </ul>
        </div>
