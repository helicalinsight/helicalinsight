...
const AreaChart = (props) => {
    ...
    if (colorField) config.seriesField = colorField;
        ...
        axisRange.fields.forEach((field) => {
            ...
            if (config.xField === field.data.name) {
                ...
                if (rotate < 0 || rotate > 0) {
                    config.xAxis = {
                        ...config.xAxis,
                        verticalLimitLength: !showAxisName ? 80 : 160,
                        title: { ...config.xAxis.title, offset: 20 }
                    }
