import qs from "qs";
import { mockData5757 } from "./5757.mock.data";
      ...
      return new Promise((resolve, reject) => {
        ...
        if (type === 'content' && serviceType === "static" && service === "getContents") {
          if (contentId === "Static/DataSourcesList") {
            return resolve({
              data: JSON.stringify(mockData5757.getStaticDSList),
            });
          }
        }
        if (
          ...
          if (
            ...
            return resolve({
              data: JSON.stringify(mockData5757.getMetaDataTables),
            });
          }
        }
        ...
        if (
          ...
          if (
            ...
            return resolve({
              data: JSON.stringify(
                mockData5757.mockdataFetchSchemaFetchCatalog
              ),
            });
          }
          ...
          if (
            ...
            return resolve({
              data: JSON.stringify(
                mockData5757.mockdataFetchTables
              ),
            });
          }
        }
    ...
    get: (url, data, config) => {
      ...
      return new Promise((resolve, reject) => {
        if (url === "listDataSources" && params.classifier === "all") {
          return resolve({
            data: JSON.stringify(mockData5757.getGetListDS),
          });
        }
