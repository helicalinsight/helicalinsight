  ...
  reports: [
    {
      ...
      savedStyles: "",
      sqlString:
        'select \n\t"HIUSER"."travel_details"."booking_platform" as "booking_platform" \nfrom\n\t"HIUSER"."travel_details" \ngroup by\n\t"HIUSER"."travel_details"."booking_platform" FETCH FIRST 10 ROWS ONLY',
      options: {
        limitBy: 1000,
        sample: "sample",
...
export const props = {
  reportId: "bce7a0d9-92a5-490a-9f3e-ed456e6226a2",
};
