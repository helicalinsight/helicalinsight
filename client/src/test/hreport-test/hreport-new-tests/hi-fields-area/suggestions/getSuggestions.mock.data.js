export const mock_data_getSuggestions = {
  value: "ASCII",
  ...
  list: [
    ...
    },
    {
      ...
      columnID: "43084",
      label: "destination",
      id: "e922a0ef-c494-4cf6-a2b6-e993b72b0655",
      type: {
    ...
    },
    {
      ...
      columnID: "43081",
      label: "sum_source_id",
      id: "e61d2021-6d0a-4778-b242-212cd0f6da4a",
      type: {
  ...
  expectedResult: [
    {
      description:
        "Returns the Unicode of the first character of string. Example: unicode('A') result:65",
      key: "sql.text.ascii",
      parameters: [{ column: true, defaultValue: "'A'", name: "string" }],
      returns: "numeric",
      signature: "unicode(${string})",
      value: "ASCII",
    },
