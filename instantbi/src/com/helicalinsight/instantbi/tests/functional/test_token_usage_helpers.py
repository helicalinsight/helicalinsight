"""Functional tests for token usage helpers in ``helicalbi.controller.helpers``."""

import pytest

from helicalbi.controller.helpers import extract_token_usage_dict, resolve_audit_status_from_response
...
class TestExtractTokenUsageDict:
    ...
    def test_supports_partial_model_state_after_failure(self):
        ...
        chat_response = ChatResponse.from_model_state(partial_state).to_dict()
