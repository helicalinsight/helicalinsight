...
|-------------|--------------|
| Windows local | `D:\hi7\instantbi\helicalbi` |
| Jenkins workspace | `/home/helical/.jenkins/workspace/HI7SourceCode/instantbi/helicalbi` |
...
```text
/home/helical/.jenkins/workspace/HI7SourceCode/instantbi/helicalbi
```

### Option A — helper script

```bash
cd /home/helical/.jenkins/workspace/HI7SourceCode/instantbi/helicalbi
...
export HELICALBI_ROOT=/home/helical/.jenkins/workspace/HI7SourceCode/instantbi/helicalbi
...
export HELICALBI_ROOT="${HELICALBI_ROOT:-$WORKSPACE/instantbi/helicalbi}"
cd "$HELICALBI_ROOT"
python3 -m venv .venv
...
2. `cd .../HI7SourceCode/instantbi && docker compose up -d pyflask`
3. `docker compose exec -T pyflask bash scripts/run_tests_with_report.sh --no-venv --skip-llm`
4. Publish `instantbi/helicalbi/reports/junit.xml` + archive reports/htmlcov
5. `docker compose down`

Obfuscation reference (HI7EndToEnd):

```bash
cd /home/helical/.jenkins/workspace/HI7SourceCode/instantbi
...
```bash
bash /home/helical/.jenkins/workspace/HI7SourceCode/instantbi/helicalbi/scripts/run_tests_with_report.sh --skip-llm
```
...
| Jenkins can’t find junit.xml | Publish path relative to `$WORKSPACE`: `instantbi/helicalbi/reports/junit.xml` |
