...
CONDITION_WIRE_MAP = {
    ...
    "CONTAINS": {"condition": "CUSTOM", "customCondition": "like", "values_pattern": "'%value%'"},
    "DOES_NOT_CONTAINS": {"condition": "CUSTOM", "customCondition": "not like", "values_pattern": "'%value%'"},
    "STARTS_WITH": {"condition": "CUSTOM", "customCondition": "like", "values_pattern": "'value%'"},
    "DOES_NOT_STARTS_WITH": {"condition": "CUSTOM", "customCondition": "not like", "values_pattern": "'value%'"},
    "ENDS_WITH": {"condition": "CUSTOM", "customCondition": "like", "values_pattern": "'%value'"},
    "DOES_NOT_ENDS_WITH": {"condition": "CUSTOM", "customCondition": "not like", "values_pattern": "'%value'"},
