      ...
      columnName=(
          ...
          Field(
              ...
              description=(
                  ...
                  "(no SQL quotes, no aliases, never *). Include columns used in "

                  "any SQL clause (SELECT, WHERE, HAVING, GROUP BY, ORDER BY). "

                  "For counts pick a real column, never COUNT(*)."
      ...
      selectColumnName=(
          ...
          Field(
              ...
              description=(
                  ...
                  "Subset of columnName that belongs in the SELECT clause "

                  "only (projected output). Qualified table.column, no SQL "

                  "quotes, no aliases, never *. Do not include WHERE / HAVING / "
