...
_CHART_OPTION_ROWS: tuple[tuple, ...] = (
    ...
    ("heatmap", 2, 2, 1, 1, "Geographic map (heatmap): lat/lon or place names vs one measure.", False, ("heat map", "heat-map", "matrix heatmap", "map", "maps", "geo map")),
    ...
    (
        ...
        1,
        None,
        "Crosstab / grid table: 2+ dimensions with at least 1 measure.",
        False,
