"""Functional tests for ``helicalbi.common.ConvertToBlankAgent``."""
from unittest.mock import patch

import pytest

from helicalbi.common.ConvertToBlankAgent import map_java_type, transform_json
...
class TestTransformJson:
    def test_collects_semantic_tables_with_profile_values(self, session_cookie):
        ...
        with patch(
            "helicalbi.common.ConvertToBlankAgent.get_json_data_metadata",
            return_value=md_all,
        ), patch(
            "helicalbi.common.ConvertToBlankAgent.get_profile_values",
