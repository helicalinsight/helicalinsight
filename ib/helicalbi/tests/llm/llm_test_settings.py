...
Provide hi-ee ``base_url`` and secrets via environment variables (preferred for
CI) or ``tests/llm/llm_test_config.local.yaml`` (gitignored):
...
Local YAML wins over committed defaults but loses to env vars.
"""
...
_DEFAULTS: dict[str, Any] = {
    # No committed host IP — set HELICALBI_TEST_BASE_URL or local yaml.
    "base_url": "",
    "session_cookie": "",
    "model_dir": "0806",
